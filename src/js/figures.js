 ...
 * @return {number} El resultado de la operación, con solo 2 decimales (en caso de tenerlos)
 */
const calcularPerimetroRectangulo = (b, h) =>
 ...
 */
const calcularPerimetroTriangulo = (a, b, c) =>
 ...
 * @return {number} El resultado de la operación
 */
const calcularAlturaTrianguloIsosceles = (a, b) =>
  Math.sqrt(a ** 2 - b ** 2 / 4);
/**
 ...
 * @return {number} El resultado de la operación
 */
const calcularAlturaTrianguloEscaleno = (a, b, c, sP) =>
  (2 / c) * Math.sqrt(sP * (sP - a) * (sP - b) * (sP - c));
/**
 ...
 * @return {number} El resultado de la operación, con solo 2 decimales (en caso de tenerlos)
 */
const calcularDiagonalRombo = (a, d) =>
  parseFloat(Math.sqrt(4 * a ** 2 - d ** 2).toFixed(2));
/**
...
function getOutput(outputFigura) {
   ...
   */
  const valorOutput = (document.getElementById(outputFigura).innerHTML =
    calculo[outputFigura]);
...
function getOutputTriangulo(output) {
  ...
  const triangulo = {
    ...
    escaAcutangulo:
      lado.a < lado.b && lado.b < lado.base && hipo.escaleno > hipo.maxEscaleno,
    escaRectangulo:
      lado.a < lado.b &&
      hipo.escaleno > hipo.minEscaleno &&
      hipo.escaleno <= hipo.maxEscaleno,
    escaObtusangulo:
      lado.a < lado.b && lado.b < lado.base && hipo.escaleno < hipo.maxEscaleno,
  };
  ...
  const semiperimetro =
    calcularPerimetroTriangulo(lado.a, lado.b, lado.base) / 2;
  ...
  if (triangulo.equilatero) {
    ...
    altura = calcularAlturaTrianguloEscaleno(
      lado.a,
      lado.b,
      lado.base,
      semiperimetro
   ...
   */
  const valorOutput = (document.getElementById(output + "Triangulo").innerHTML =
    calculo[output]);
 ...
 */
const outputCuadrado = () =>
  getOutput("perimetroCuadrado") && getOutput("areaCuadrado");
//----------------------------------------------------------------------------------------------------
//Rectangulo
/**
 * Enviar al archivo HTML los valores de salida
 * @return {number} Los valores de getOutput a los ID's de salida
 */
const outputRectangulo = () =>
  getOutput("perimetroRectangulo") && getOutput("areaRectangulo");
//----------------------------------------------------------------------------------------------------
//Triangulo
/**
 * Enviar al archivo HTML los valores de salida
...
function outputTriangulo() {
  getOutputTriangulo("altura") &&
    getOutputTriangulo("perimetro") &&
    getOutputTriangulo("area");
}
//----------------------------------------------------------------------------------------------------
//Rombo
/**
 ...
 */
const outputRombo = () =>
  getOutput("diagonalRombo") &&
  getOutput("perimetroRombo") &&
  getOutput("areaRombo");
//----------------------------------------------------------------------------------------------------
//Circulo
/**
 ...
 */
const outputCirculo = () =>
  getOutput("circunferencia") && getOutput("areaCirculo");
