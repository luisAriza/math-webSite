 ...
 */
export const diamondPerimeter = (side) => parseFloat((side * 4).toFixed(2));
/**
 ...
 */
export const diamondDiagonal = (side, d) =>
 ...
 * @return {number} El resultado de la operación, con solo 2 decimales (en caso de tenerlos)
 */
export const diamondArea = (D, d) => parseFloat(((D * d) / 2).toFixed(2));
